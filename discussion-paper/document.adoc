...
:comment: ### Author two
:fullname_2: Hatsuho Kamata
:comment: ### Author three
:fullname_3: Yuki Hara
:comment: ### Role of the authors; mandatory
:role: editor
:comment: ### Comma delimited keywords; mandatory
:keywords: ogcdoc, OGC document, GFM, deep learning, point cloud, remote sensing
:comment: ### Semicolon-delimited list of the submitting organizations; mandatory
:submitting-organizations: National Institute of Advanced Industrial Science and Technology
...
include::sections/clause_6_informative_text_satellite.adoc[]

include::sections/clause_7_informative_text_pointcloud.adoc[]
