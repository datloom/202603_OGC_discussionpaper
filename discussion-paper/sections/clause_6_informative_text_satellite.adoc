...
As introduced, studies on GFMs for satellite imagery is thriving. However some limitations have been mentioned. +
First, GFMs lack of local generalization and domain generalization.
