...
or an FPN-based detection head for object detection.
...
The modeld are fine-tuned using the specified hyperparameter values and then evaluted with metrics.  It is recomended to repeat the fine-tuning process 
