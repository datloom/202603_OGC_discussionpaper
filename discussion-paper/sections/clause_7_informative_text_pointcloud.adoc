...
Therefore, if a core set of GeoAI tasks were established, GFM developers would be able to determine which subset of tasks their resulting GFM can effectively adapt to.
